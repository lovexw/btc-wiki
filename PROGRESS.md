...
>
> 最后更新：2026-09-13（术语精翻 B6 隐私与合规批全部完成 21/21，累计 218/476；下批为 B7 字母序扫尾，断点详情见下方「B7 断点」）
...
| glossary/ 术语表（全文精翻） | 476 | 218 | ⏳ 进行中，按下方批次计划推进 |
...
| B7 | 字母序扫尾（断点清单见上方） | 不匹配上述关键词的其余全部剩余词条，每 50 条一批 | 258 |
