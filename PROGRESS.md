...
>
> 最后更新：2026-09-13（术语精翻 B7 第二批完成 50/50，累计 318/476；第三批 50 条从 `counterparty-risk` 起，断点详情见下方「B7 断点」）
...
| glossary/ 术语表（全文精翻） | 476 | 318 | ⏳ 进行中，按下方批次计划推进（B7 第一、二批已完成） |
...
| B7 | 字母序扫尾（第一、二批各 50 条 ✅ 2026-09-13 完成，断点清单见上方） | 不匹配上述关键词的其余全部剩余词条，每 50 条一批 | 158 |
